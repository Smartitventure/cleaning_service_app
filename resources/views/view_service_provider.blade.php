                                ...
                                <div class="col-md-12 custom-col">
                                     <div class="leftbox">
                                        <div class="custom-imagebox">
                                            @if(!is_null($service_provider->image))

                                            <img src="{{asset($service_provider->image)}}" />
                                            @else
                                                <img src="{{asset('images/dummy.jpg')}}">
                                            @endif
                                    </div>
                                        <h3>{{ucfirst($service_provider->name)}}</h3>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <div class="mail-box">
                                        ...
                                        <p>{{$service_provider->gender}}</p>
                                    </div>
                                    <div class="mail-box">
                                        <div class="iocn-box">
                                            <i class="fa fa-calendar" aria-hidden="true"></i>
                                        </div>
                                        <p>{!! date('d M, Y', strtotime($service_provider->created_at)) !!}</p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="personal-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="contactinforight">
                                        <h5>{{$service_provider->mobile_number}}</h5>
                                ...
                                <div class="col-md-6">
                                    <div class="contactinforight">
                                        <h5>{{$service_provider->company}}</h5>
